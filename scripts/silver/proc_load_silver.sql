...
BEGIN
    ...
    BEGIN TRY
        ...
        INSERT INTO silver.crm_cust_info (
            cust_id, cust_key, cust_firstname, cust_lastname, cst_material_status, cst_gndr, cst_create_date
        )
        SELECT
            cust_id,
            cust_key,
        ...
        INSERT INTO silver.crm_prd_info (
            prd_id, cat_id, prd_key, prd_nm, prd_cost, prd_line, prd_start_date, prd_end_date
        )
        SELECT
            prd_id,
